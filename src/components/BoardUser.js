...
export default class BoardUser extends Component {
  ...
  saveBook = (e) => {
    ...
    let book = {title:this.state.title, author:this.state.author, imageUrl:this.state.imageUrl, isbn:this.state.isbn, price:this.state.price, language:this.state.language, genre:this.state.genre};
    bookService.createBook(book)
        .then(res => {
            this.setState({snackbaropen:true, message:'Book added successfully', colors:'success'})
            ...
            <Grid container>
              ...
              <Grid item xs={8} style={{backgroundColor:"#212121", margin:"20px"}}>
                <CardContent style={style.cardsty}>
                  <CardActions>
                    <CardContent>
                      <h2><FontAwesomeIcon icon={faEdit}/>Add New Book</h2>
                      <br/>
                      <br/>
                      <Grid container spacing={3}>
                  ...
                  <CardActions style={{float: 'right'}}>
                        ...
                        <FormControl>
                          <Button href="" variant="contained" color="primary" href="/"
